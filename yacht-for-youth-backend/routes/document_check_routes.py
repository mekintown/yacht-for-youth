...
class CheckDocumentResource(Resource):
    ...
    def analyze_contract_text(self, text):
        ...
        possible_issues = {
            ...
            "ชั่วโมงทำงานไม่เกิน 9 ชั่วโมงต่อวัน ": "พบการทำงานเกินกว่ามาตรฐาน 8 ชั่วโมงต่อวัน",
            ...
            "นายจ้างต้องจ่ายค่าล่วงเวลาให้ลูกจ้างในอัตราเดียวกันกับค่าจ้างตามปกติ": "พบการไม่จ่ายค่าล่วงเวลาในอัตราที่สูงกว่าค่าจ้างปกติ",
        }
